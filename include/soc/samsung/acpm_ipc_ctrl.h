...
#else
static inline void exynos_acpm_set_s2d_enable(int en)
{
	return;
}

static inline int exynos_acpm_s2d_update_en(void)
{
	return 0;
}
static inline void exynos_acpm_select_s2d_blk(u32 sel)
{
	return;
}
#endif
