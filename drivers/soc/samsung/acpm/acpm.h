...
static inline void exynos_acpm_timer_clear(void) { }
static inline void exynos_ss_regulator(u64 time, const char *name,
				       u32 on, u32 old_uV, u32 new_uV,
				       u32 reg) { }
static inline void exynos_ss_acpm(u64 time, const char *str, u32 val) { }
...
static inline void *memcpy_align_4(void *dest, const void *src,
				   unsigned int n)
{
	u32 *dp = dest;
	const u32 *sp = src;
