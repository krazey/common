...
void start_kernel(void)
{
	...
	pid_idr_init();
	exynos9810_boot_marker('B', '0');
	anon_vma_init();
	exynos9810_boot_marker('B', '1');
	thread_stack_cache_init();
	exynos9810_boot_marker('B', '2');
	cred_init();
	exynos9810_boot_marker('B', '3');
	fork_init();
	exynos9810_boot_marker('B', '4');
	proc_caches_init();
	exynos9810_boot_marker('B', '5');
	uts_ns_init();
	exynos9810_boot_marker('B', '6');
	time_ns_init();
	exynos9810_boot_marker('B', '7');
	key_init();
	exynos9810_boot_marker('B', '8');
	security_init();
	exynos9810_boot_marker('B', '9');
	dbg_late_init();
	exynos9810_boot_marker('B', 'A');
	net_ns_init();
	exynos9810_boot_marker('B', 'B');
	vfs_caches_init();
	exynos9810_boot_marker('B', 'C');
	pagecache_init();
	exynos9810_boot_marker('B', 'D');
	signals_init();
	exynos9810_boot_marker('B', 'E');
	seq_file_init();
	exynos9810_boot_marker('B', 'F');
	proc_root_init();
	exynos9810_boot_marker('C', '0');
	nsfs_init();
	exynos9810_boot_marker('C', '1');
	pidfs_init();
	exynos9810_boot_marker('C', '2');
	cpuset_init();
	exynos9810_boot_marker('C', '3');
	mem_cgroup_init();
	exynos9810_boot_marker('C', '4');
	cgroup_init();
	exynos9810_boot_marker('C', '5');
	taskstats_init_early();
	exynos9810_boot_marker('C', '6');
	delayacct_init();
	exynos9810_boot_marker('C', '7');

	acpi_subsystem_init();
	exynos9810_boot_marker('C', '8');
	arch_post_acpi_subsys_init();
	exynos9810_boot_marker('C', '9');
	kcsan_init();
...
static noinline void __init kernel_init_freeable(void)
{
	...
	if (IS_ENABLED(CONFIG_EXYNOS9810_SINGLE_CPU_BRINGUP))
		setup_max_cpus = min(setup_max_cpus, 1U);
